...
- We prefer no AI tooling is used (e.g., Copilot, ChatGPT, Claude). This exercise is designed to evaluate your Terraform and infrastructure knowledge directly. If you do use AI assistance, please disclose what you used and how.
